...
#SBATCH -w ariel-v2
#SBATCH -t 3-0
#SBATCH -o /nas2/data/dpfla3573/code/MoScale/logs/slurm-%A_seg_vqdec_v2-1.out
...
/nas2/data/dpfla3573/anaconda3/envs/moscale/bin/python train_seg_vqdec.py
