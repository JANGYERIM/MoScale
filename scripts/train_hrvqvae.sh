...
#SBATCH -w ariel-v3
#SBATCH -t 4-0
#SBATCH -o /nas2/data/dpfla3573/code/MoScale/logs/slurm-%A_train_hrvqvae.out
...
/nas2/data/dpfla3573/anaconda3/envs/moscale/bin/python train_hrvqvae.py
